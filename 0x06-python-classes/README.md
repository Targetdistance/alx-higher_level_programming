...
Project done during **Full Stack Software Engineering studies** at **ALX School Africa**. It aims to learn about object oriented programming (OOP), classes, objects, instances, methods and attributes in **Python**.
...
| `103-magic_class.py` | Define a MagicClass that does exactly as the bytecode provided |
